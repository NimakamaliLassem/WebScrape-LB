...
import os
os.chdir("C:\\Users\\student\\Python\\Python310\\Scripts\\Documents\\")
os.getcwd()
...
driver = webdriver.Chrome(executable_path="C:\\Users\\student\\Python\\Python310\\chromedriver.exe")
#implicit wait
...
def get_data(links, num):
    ...
    for link in links:
        ...
        with open(last_char, "w", encoding="utf-8") as file:
            file.write(str(res))
            file.close()
        cnt = cnt+1
        # except IOError:
